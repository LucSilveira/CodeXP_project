    ...
    public partial class CoorganicasContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Server=DESKTOP-LKMH5JG\\SQLEXPRESS;Database=Coorganicas; User Id=sa; Password=132");
                optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS; Database=Coorganicas; User Id=sa; Password=root");
            }
        }
